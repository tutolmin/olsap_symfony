...
class HardwareProfilesFixtures extends Fixture {
    ...
    public function __construct(HardwareProfilesManager $hpManager) {
//        parent::__construct();
    ...
    public function load(ObjectManager $manager): void {
        ...
        $this->hpManager->addHardwareProfile($hw_profile);
/*
        $manager->flush();

        // Add corresponding instance types
        if ($hw_profile->isSupported()) {
            $this->hpManager->addInstanceTypes($hw_profile);
        }
 * 
 */
    }
