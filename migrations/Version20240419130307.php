 ...
 */
final class Version20240419130307 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE operating_systems ALTER supported SET DEFAULT false');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE operating_systems ALTER supported DROP DEFAULT');
